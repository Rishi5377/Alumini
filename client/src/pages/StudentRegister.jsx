...
export default function StudentRegister() {
    ...
    const handlePhase1Next = (e) => {
        e.preventDefault();
        if (!name.trim() || !rollNumber.trim() || !presentYear || !password) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            fd.append("presentYear", presentYear);
            ...
            const res = await axios.post("/api/students/register", fd, {
        ...
        <div className="page-wrapper">
            ...
            <div className="glass-card" style={{ width: "100%", maxWidth: "560px", padding: "2.5rem 2.25rem" }}>
                ...
                <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
                    ...
                    <p className="page-subtitle">Create your profile to connect with mentors</p>
                </div>
                ...
                <div className="phase-stepper">
                    ...
                    <div className="phase-step">
                        ...
                        <span className={`phase-label ${phase === 2 ? "active" : "pending"}`}>Profile</span>
                    </div>
                </div>
                    ...
                    <form onSubmit={handlePhase1Next} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <input className="form-input" placeholder="e.g. 21CS101" value={rollNumber} onChange={(e) => setRollNumber(e.target.value)} required />
                            </div>
                            <div className="form-group">
                                <label className="form-label">Present Year <span className="req">*</span></label>
                                <select className="form-input" value={presentYear} onChange={(e) => setPresentYear(e.target.value)} required>
                        ...
                        <p style={{ textAlign: "center", fontSize: "0.8125rem", color: "var(--slate-500)" }}>
                            Already registered?{" "}
                            <span className="link" onClick={() => navigate("/student/login")}>Sign in</span>
                        </p>
                    </form>
                )}
                ...
                {phase === 2 && (
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                        <div className="section-title" style={{ color: "var(--cyan-400)", marginBottom: "0.25rem" }}>
                            <span className="dot cyan" /> Profile Details
                        </div>

                        <div className="form-group">
                            <label className="form-label">About Yourself</label>
                            <textarea className="form-input" rows="4" placeholder="Tell us about yourself — interests, goals, aspirations..." value={about} onChange={(e) => setAbout(e.target.value)} />
                        </div>

                        <div className="form-group">
                            <label className="form-label">Skills</label>
                            <input className="form-input" placeholder="React, Python, Java, …" value={skills} onChange={(e) => setSkills(e.target.value)} />
